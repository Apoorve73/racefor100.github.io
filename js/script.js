...
var round_count = 1
  ...
  function beginGame() {
    alert('Welcome to the game! This is round ' + round_count + ' ' + uname +
  ...
  function declareWinner() {
    ...
    else {alert("You've tried well. It's a tie.")} reset()
  }
  /**
  ...
  function raceforit(sum, _count, compcount, btnShow) {
    ...
    function showScoreboard(number, sum, computer) {
      ...
      sumArea.innerText = 'Total sum = Previous Sum + ' + number + ' + ' +
                          computer + ' = ' + sum
    }
  }
  /**
